 ...
 */
#ifndef TCP_MSS
#define TCP_MSS                         1100//(1500 - 40)     /* TCP_MSS = (Ethernet MTU - IP header size - TCP header size) */
#endif
...
#define PPP_MAXMTU                      1000 /* Largest MTU we allow */
#endif
#define PPP_MINMTU                      64
#define PPP_MRU                         1000     /* default MRU = max length of info field */
#define PPP_MAXMRU                      1000     /* Largest MRU we allow */
#ifndef PPP_DEFMRU
